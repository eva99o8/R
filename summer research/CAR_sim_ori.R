...
source("R:\\Research problems\\JAGS\\Spatial temporal Bayesian hierarchical model\\outbreak_detection_marginalization(Latest)\\Favorite Baby!!\\Loading_real_data.R")
source(("R:\\Research problems\\JAGS\\Spatial temporal Bayesian hierarchical model\\outbreak_detection_marginalization(Latest)\\Favorite Baby!!\\user_defined_funcs.R"))
source(("R:\\Research problems\\JAGS\\Spatial temporal Bayesian hierarchical model\\outbreak_detection_marginalization(Latest)\\Favorite Baby!!\\Y_sim_generate.R"))
###
logoffset = log(Xpop)
...
### All the parameters
rho_temp =.5; tau_temp = 1/0.2
tau_spat = 1/.3; rho_spat =.5
